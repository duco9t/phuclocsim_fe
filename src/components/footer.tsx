        ...
        <>
            <footer className="footer sm:footer-horizontal bg-base-200 text-base-content p-10">
                <nav>
                    ...
                    <a className="link link-hover">Luận sim phong thủy</a>
                    <a className="link link-hover">Tư vấn sim số đẹp</a>
                    <a className="link link-hover">Bài viết phong thủy</a>
                    <a className="link link-hover">Quảng cáo & hợp tác</a>
                </nav>
                <nav>
                    ...
                    <a className="link link-hover">Đối tác</a>
                </nav>
                <nav>
